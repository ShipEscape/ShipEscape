...
public class MainActivity extends AppCompatActivity {
    ...
    private final BluetoothAdapter.LeScanCallback leScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            ...
            runOnUiThread(() -> Toast.makeText(MainActivity.this, "扫到:"+address+" RSSI:"+rssi, Toast.LENGTH_SHORT).show());
            ...
            if (matchIndex != -1) {
                ...
                runOnUiThread(() -> Toast.makeText(MainActivity.this, "匹配信标"+matchIndex+" 距:"+String.format("%.1f", dist)+"m", Toast.LENGTH_SHORT).show());
                calculatePosition();
            }
        }
    };
    ...
    private void calculatePosition() {
        ...
        runOnUiThread(() -> Toast.makeText(MainActivity.this, "✅ 定位成功 X:"+String.format("%.1f",x)+" Y:"+String.format("%.1f",y), Toast.LENGTH_LONG).show());
        // 定位成功后更新地图红点
